...
- 主导 **22+** 项性能优化与重构，覆盖备份、查询、导出和事件处理链路。代表性成果包括：10,000 台虚拟机扫描从 **2 小时** 缩短到 **10 分钟**，10,000 个副本归档队列内存从 **2 GB** 降至 **56 MB**，批量取消从 **1 分钟/任务** 降至 **0.5 秒/任务**，400 万条告警/事件转储从 **24 小时** 缩短到 **35 秒**。
